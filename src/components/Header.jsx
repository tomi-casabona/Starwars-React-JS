    ...
    <>
      <header className="bg-black bg-opacity-75">
        <div className="w-3/4 flex lg:flex-row flex-col gap-3 justify-center items-center bg-transparent text-white lg:h-36 mx-auto mb-5 mt-10 lg:my-0">
          ...
          <div className="w-full lg:w-2/4 lg:h-full flex items-center" onClick={() => navigate('/')}>
          ...
          <div className="lg:w-1/4 flex justify-center">
            ...
            <button className="text-nowrap flex items-center gap-2 px-2 py-1 mx-3 hover:[text-shadow:#FFF_1px_0_10px;] uppercase font-sans font-bold" onClick={() => navigate("/logIn")}>
              <img className="inline" src="https://static-mh.content.disney.io/matterhorn/assets/starwars/navigation/SW_Oneid_User-85043c6786ab.svg" />Log In
            </button>
            <button className="text-nowrap flex items-center gap-2 px-2 py-1 mx-3 hover:[text-shadow:#FFF_1px_0_10px;] uppercase font-sans font-bold" onClick={() => navigate("/signIn")}>
              Sign In
            </button>
            <button className="text-nowrap flex items-center gap-2 px-2 py-1 mx-3 hover:[text-shadow:#FFF_1px_0_10px;] uppercase font-sans font-bold" onClick={handleSignOut}>
              Sign Out
            </button>
          </div>
        </div>
